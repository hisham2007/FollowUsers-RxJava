 ...
 *      complete}
 */
public abstract class StateRemovableFragmentStatePageAdapter extends PagerAdapter {
    private static final String TAG = "StateRemovableFragmentStatePageAdapter";
    ...
    public StateRemovableFragmentStatePageAdapter(FragmentManager fm) {
        mFragmentManager = fm;
    }
